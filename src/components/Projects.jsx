...
const Projects = () => {
  return (
    ...
    className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
      ...
      <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Crafting Spaces, Building Lagacies-Explore-our Portfolio</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {projectsData.map((project, index) => (
          ...
          >
            ...
            />
            <div className='absolute left-0 right-0 bottom-5 flex justify-between items-center'>
